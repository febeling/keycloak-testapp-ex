defmodule KeycloakTestappExWeb.UserControllerTest do
  use KeycloakTestappExWeb.ConnCase

  import KeycloakTestappEx.AccountsFixtures

  @create_attrs %{name: "some name", provider: "some provider", uid: "some uid", email: "some email"}
